  ...
  >
    ...
    >
      ...
      <v-flex
        xs12
        md6
        class="rw-words rw-words-1 text-xs-center "
      >
        <v-flex
          xs6
...
.parallaxMain {
  ...
  .rw-wrapper {
    ...
    .rw-words-1 div {
      ...
      -ms-animation: rotateWord 35s linear infinite 0s;
      animation: rotateWord 35s linear infinite 0s;
      min-height: 50px;
    }
